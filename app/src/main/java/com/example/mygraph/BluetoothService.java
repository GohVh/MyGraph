...
*/
        ...
        connectThread.start();
        MainActivity.textViewStream.setText("Streaming");
    }
    ...
    public void stopClient(BluetoothDevice device, UUID uuid){
        ...
        connectThread.cancel();
        MainActivity.textViewStream.setText("Streaming stopped");
    }
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run(){
            ...
            Log.d(TAG, "DATA: " + data);
            MainActivity.myDb.insertData(currentDateandTime,data);
