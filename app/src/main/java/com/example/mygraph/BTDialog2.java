...
public class BTDialog2 extends AppCompatDialogFragment {
    ...
    private void scan() {
        if(MainActivity.myBluetoothAdapter.isDiscovering()){
            MainActivity.myBluetoothAdapter.cancelDiscovery();
            Log.d(TAG, "Canceling discovery.");
            checkBTPermissions();

            MainActivity.myBluetoothAdapter.startDiscovery();
